...
// Takes as input a trajectory in the format generated by Trajectory_stv.c, and converts it to a step
...
main(int argc, char **argv){
    ...
    double a,b,c,*freq,*mytimes,p,t,*fudge,s,age,freqstv;
    ...
    for(traj=0;traj<ntrajs;traj++){
        ...
        countints=0;
        while(1){
            sscanf(line,"# s: %lf age: %lf freq: %lf",&s,&age,&freqstv);
        ...
        printf("n:\t%d s: %lf age: %.10f freq: %lf\n",countints-1,s,age,freqstv);
